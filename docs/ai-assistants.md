...
- **First paragraph**: describe the program's **current state** (what it has or provides)
...
**Key rules:**
- Write in **present tense** about the current state ("has", not "used to have")
...
✅ First paragraph describes current state:
```
