...
from .models import LineLevelChange, HunkHeader, LineEntry, SingleHunkPatch
...
def build_line_changes_from_patch_text(patch_text: str) -> LineLevelChange:
    ...
    return LineLevelChange(path=path_value, header=hunk_header, lines=line_entries)
