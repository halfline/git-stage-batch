...
def create_batch_source_commit(file_path: str) -> str:
    ...
    # For new files (didn't exist at session start), use current working tree content
    # This ensures the batch source has the lines we're actually claiming
    if not file_existed_at_session_start:
