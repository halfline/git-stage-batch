...
from git_stage_batch.commands.install_assets import _copy_traversable_tree, command_install_assets
...
class TestCommandInstallAssets:
    ...
    def test_copy_traversable_tree_ignores_python_cache_artifacts(self, tmp_path):
