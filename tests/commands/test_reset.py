...
from git_stage_batch.batch.source.cache import save_session_batch_sources
...
class TestResetFromBatch:
    ...
    def test_reset_line_claims_reject_stale_review_before_raw_id_fallback(self, temp_git_repo, monkeypatch):
        ...
        monkeypatch.setattr(batch_review_selection_module, "render_batch_file_display", render_with_raw_gutter)
        monkeypatch.setattr(file_review_freshness_module, "render_batch_file_display", render_with_raw_gutter)
    ...
    def test_reset_line_with_explicit_file_uses_metadata_batch_source(self, temp_git_repo):
        ...
        with LineBuffer.from_bytes(b"unrelated cache content\n") as wrong_source_buffer:
