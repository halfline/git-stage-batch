...
class TestCommandStatus:
    ...
    def test_status_porcelain_includes_current_hunk(self, temp_git_repo, capsys):
        ...
        # Should have current hunk details (if full state caching is implemented)
        # At this stage, show.py may only cache patch+hash, not full CurrentLines
        if output["current_hunk"] is not None:
