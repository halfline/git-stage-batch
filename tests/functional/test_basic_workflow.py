...
class TestSkipWorkflow:
    ...
    def test_skip_to_next_hunk(self, repo_with_changes):
...
class TestShowCommand:
    ...
    def test_show_displays_current_hunk(self, repo_with_changes):
        """Test show displays current hunk with line IDs."""
        git_stage_batch("start")
